...
def main(page: ft.Page):
    ...
    page.title = "Quiz - Teste seus conhecimentos!"  # Define o título da janela do aplicativo
    ...
    QuizUI(page, quiz_logic)  # Inicializa a interface do usuário, passando a página e a lógica do quiz
