...
from quiz_logic import QuizLogic  # Importa a classe QuizLogic que gerencia a lógica do quiz
from .views import (
    ...
    reproduzir_audio,  # Importa a função para reproduzir áudio
)
    ...
    def verificar_resposta(self, e):
        ...
        if not self.estado_quiz.quiz_finalizado:
            ...
            if e.control.data == resposta_correta:
                ...
                # Reproduz o áudio de resposta correta, se o som estiver ativado
                if self.som_ativado:
                    reproduzir_audio("certo")
            else:
                # Reproduz o áudio de resposta incorreta, se o som estiver ativado
                if self.som_ativado:
